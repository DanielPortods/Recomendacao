...
from commons.Tariff import BlueTariff
...
class BluePercentileCalculator():
    ...
    def __calculate_percentiles(self):
        ...
        for p in self.PERCENTILES:
            ...
            Percentiles().save_demands(peak_demand_in_kw_percentile, off_peak_demand_in_kw_percentile, percentiles[p_str].demand_total_cost_in_reais.sum())
        return percentiles
